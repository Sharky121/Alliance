<head>
    ...
    <?php else: ?>
        <title>Альянс-пром - поставка оборудование для литья пластмасс (ТПА), литья под давлением цветных металлов и сплавов, периферийного оборудования, конструирование и поставка пресс-форм</title>
    <?php endif; ?>    
