<main>
  <div class="container">
    <h1 class="main-title">Пресс-формы</h1>
    ...
    <ul class="breadcrumbs-list">
      ...
      <li class="breadcrumbs-list__item breadcrumbs-list__item--active">
        <a class="breadcrumbs-list__link">Пресс-формы</a>
      </li>
    </ul>

    <p>Поставляем пресс-формы высокого качества для литья изделий из пластмасс и цветных металлов от специализированных заводов Китая.</p>

    <p>Холодноканальные, горячеканальные, комбинированные для литья изделий любой сложности, габаритов а так же с закладными элементами.</p>

    <ul class="collection">
      <li class="collection-item">Разработка 3D модели по чертежу, образцу, фотографии изделия</li>
      <li class="collection-item">Возможность внесения корректировок на всех этапах изготовления</li>
      <li class="collection-item">Короткий срок расчета стоимости пресс-формы</li>
      <li class="collection-item">Гарантия 12 месяцев или по количеству смыканий</li>
    </ul>

    <h4>Для получения расчета заполните приложенную форму:</h4>

    <form class="pressForm-form">
      ...
      <div class="form-group question-form__form-group">
        <p>
          <label class="form-label form-label--grey" for="title">Наименование пресс-формы</label>
          <input class="form-input form-input--grey" id="title" name="title" type="text" placeholder="Наименование">
        </p>

        <p>
          <label class="form-label form-label--grey" for="logoForm">Надписи</label>
          <input class="form-input form-input--grey" id="logoForm" name="logo" type="text" placeholder="Надписи">
        </p>


        <p>
          <label class="form-label form-label--grey" for="size">Габ. размеры изделия, мм</label>
          <input class="form-input form-input--grey" id="size" name="size" type="text" placeholder="Габ. размеры изделия, мм">
        </p>
        ...
        <p>
          <label class="form-label form-label--grey" for="material">Материал изделия (марка материала)</label>
          <input class="form-input form-input--grey" id="material" name="material" type="text" placeholder="Материал изделия (марка материала)">
        </p>

        <p>
          <label class="form-label form-label--grey" for="distance">Расстояние между колоннами, мм</label>
          <input class="form-input form-input--grey" id="distance" name="distance" type="text" placeholder="Расстояние между колоннами, мм">
        </p>
      </div>
